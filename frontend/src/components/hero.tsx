  ...
  return (
    <div className="flex items-center justify-center relative mt-14">
      <div className="absolute inset-0">
        <img src="/Hero.png" className="w-full h-full object-fit" />
      </div>
      <div className="flex flex-col items-center w-[834px] mt-14 gap-12 px-2 py-4 z-10">
        <div className="flex flex-col items-center justify-center gap-4">
          ...
          <div className="flex items-center gap-4">
            <button className="text-sm rounded-full px-4 py-3 bg-secondary border-[1px] font-medium h-10 flex items-center justify-center transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-secondary/30 hover:bg-secondary/80">
              Request demo
            </button>
            <button className="text-sm rounded-full gap-2 px-4 py-3 border-white border-[1px] font-medium h-10 flex items-center justify-center transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-white/20 hover:bg-white/10">
              Watch a 90-sec demo
            </button>
          </div>
        </div>
        ...
        <div className="flex items-center justify-center gap-4">
          ...
          >
            <img src="/Lock.svg" width="16px" height="16px" />
          ...
          >
            <img src="/ShieldCheck.svg" width="16px" height="16px" />
          ...
          <div
            className="flex items-center justify-center w-fit gap-2 font-semibold bg-black px-4 py-3
                        rounded-full border-white border-[1px] bg-black/50"
          >
            <img src="/Medal.svg" width="16px" height="16px" />
